...
insert into survey (survey_id, country_code, name) values('survey_id2', 'US', 'test_survey1');

insert into question (question_id, survey_id, name) values('question_id4', 'survey_id2', 'question1');
insert into question (question_id, survey_id, name) values('question_id5', 'survey_id2', 'question2');

insert into answer (answer_id, question_id, name) values('answer_id10', 'question_id4', 'true');
insert into answer (answer_id, question_id, name) values('answer_id11', 'question_id4', 'false');

insert into answer (answer_id, question_id, name) values('answer_id12', 'question_id5', 'true');
insert into answer (answer_id, question_id, name) values('answer_id13', 'question_id5', 'false');
